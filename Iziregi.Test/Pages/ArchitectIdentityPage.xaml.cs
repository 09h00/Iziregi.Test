// File: Pages/ArchitectIdentityPage.xaml.cs
using System;
using System.IO;
using System.Linq;
...
// ✅ Converti depuis ArchitectIdentityWindow (23.07.2026, demande de Joe) : cette page s'ouvrait
// auparavant dans une fenêtre modale maximisée qui masquait complètement la barre de navigation.
// Embarquée maintenant dans MainContent comme les autres pages (Dashboard, Archives...), la barre
// de navigation reste visible en permanence.
public partial class ArchitectIdentityPage : System.Windows.Controls.UserControl, IReloadablePage
{
